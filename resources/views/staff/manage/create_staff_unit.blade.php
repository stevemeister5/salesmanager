	                   ...
	                   <div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="unit_name">
										Staff Unit <span class="symbol required font"></span>
									</label>
									<input required value="" autocomplete="off" class="form-control underline" id="unit_name" placeholder="Enter Unit" type="text" name="unit_name">
					    ...
					    <div class="row">
							<div class="col-md-6">
								<button class="btn btn-success btn-block btn-scroll btn-scroll-left ti-book create" type="button"><span>CREATE STAFF UNIT</span></button>
							</div>
					   </div>
