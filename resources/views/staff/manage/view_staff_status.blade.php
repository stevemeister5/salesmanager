...
@section('content')
		  ...
		  @if( $staff_status_collection->isEmpty())
		  ...
		  @else
			...
			<div id="initial" class="init">
				 <h5 class="over-title" style="margin-top:29px !important"><span class="text-bold badge badge-success "> <?php echo $staff_status_collection->count() ?></span> staff status created! </h5>

						<table class="table table-striped table-bordered table-hover table-full-width sample_1">
										<thead>
											<tr>
												<th>  </th>
												<th class="center">Status Name</th>
											</tr>
										</thead>
										<tbody>
											...
											<tr data-id="{{ $val->status_id }}">
												<td style="width: 30px">
											@if(Route::current()->getName() == 'edit_staff_status')
											<i data-action="edit" style="cursor: pointer" class="ti-pencil-alt" data-placement="right" data-toggle="tooltip" data-original-title="Edit {{ $val->status_name }}"></i>
											...
											@endif
												...
												<td class="center">{{ $val->status_name }}</td>
						...
						<div class="modal-dialog modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">Edit Staff Status</h4>
								</div>
						 ...
						 $.ajax(
								 {
									 ...
									 url:"{{route('get_edit_staff_status')}}",
									 beforeSend:function()
									  {
