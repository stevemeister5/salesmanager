...
@section('content')
		  ...
		  @if( $doc_types_collection->isEmpty())
		  ...
		  @else
			...
			<div id="initial" class="init">
				 <h5 class="over-title" style="margin-top:29px !important"><span class="text-bold badge badge-success "> <?php echo $doc_types_collection->count() ?></span> document types created! </h5>

						<table class="table table-striped table-bordered table-hover table-full-width sample_1">
										<thead>
											<tr>
												<th>  </th>
												<th class="center">Document Type Name</th>
											</tr>
										</thead>
										<tbody>
											...
											@foreach($doc_types_collection as $val)
											
											<tr data-id="{{ $val->docs_id }}">
												<td style="width: 30px">
											@if(Route::current()->getName() == 'edit_doc_type')
											<i data-action="edit" style="cursor: pointer" class="ti-pencil-alt" data-placement="right" data-toggle="tooltip" data-original-title="Edit {{ $val->docs_type }}"></i>
											...
											@endif
												...
												<td class="center">{{ $val->docs_type }}</td>
						...
						<div class="modal-dialog modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">Edit Document Type</h4>
								</div>
