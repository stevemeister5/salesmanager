...
@section('content')
		  ...
		  @if( $staff_resumption_collection->isEmpty())
				<div class="alert alert-block alert-danger fade in">
					...
					<p class="margin-bottom-10">
						No Staff Resumption Types Created
					</p>
		  ...
		  @else
			...
			<div id="initial" class="init">
				 <h5 class="over-title" style="margin-top:29px !important"><span class="text-bold badge badge-success "> <?php echo $staff_resumption_collection->count() ?></span> staff resumption types(s) created! </h5>

						<table class="table table-striped table-bordered table-hover table-full-width sample_1">
										<thead>
											<tr>
												<th>  </th>
												<th class="center">Resumption Type Name</th>
										...
										<tbody>
											...
											<tr data-id="{{ $val->resume_type_id }}">
												<td style="width: 30px">
											@if(Route::current()->getName() == 'edit_staff_resumption')
											<i data-action="edit" style="cursor: pointer" class="ti-pencil-alt" data-placement="right" data-toggle="tooltip" data-original-title="Edit {{ $val->resume_type_name }}"></i>
											...
											@endif
												...
												<td class="center">{{ $val->resume_type_name }}</td>
							<td class="center"><?php echo date("h:i:s A",strtotime($val->resume_type_start_time)) ?></td>
							<td class="center"><?php echo date("h:i:s A",strtotime($val->resume_type_end_time)) ?></td>
						...
						<div class="modal-dialog modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">Edit Resumption Type</h4>
								</div>
						 ...
						 $.ajax(
								 {
									 ...
									 url:"{{route('get_edit_staff_resumption')}}",
									 beforeSend:function()
									  {
