	                   ...
	                   <div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="dept_name">
										Staff Department <span class="symbol required font"></span>
									</label>
									<input required value="" autocomplete="off" class="form-control underline" id="dept_name" placeholder="Enter Staff Department" type="text" name="dept_name">
					    ...
					    <div class="row">
							<div class="col-md-6">
								<button class="btn btn-success btn-block btn-scroll btn-scroll-left ti-book create" type="button"><span>CREATE STAFF DEPARTMENT</span></button>
							</div>
					   </div>
